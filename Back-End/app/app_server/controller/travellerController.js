...
var travellerController = {
    ...
    viewtraveller: (req, res, next) => {
        ...
        travellerSchema.findOne({ 'phoneNumber': req.params.phoneNumber }, function (err, result) {
    ...
    updatetraveller: (req, res, next) => {
        ...
        travellerSchema.findOneAndUpdate({'phoneNumber': req.params.phoneNumber},
    ...
    viewtravellerByName: (req, res, next) => {
